...
<ul class="nav nav-pills align-items-center">
 ...
 <div class="container" style="max-width: 900px;">
    ...
    <form id="suspectForm" novalidate>
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" placeholder="e.g., John Anderson" required />
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-md-4">
              ...
              <input type="number" id="age" class="form-control" placeholder="e.g., 34" required />
          ...
          <div class="mb-3">
            ...
            <input type="text" id="address" class="form-control" placeholder="e.g., 123 Oak Street, Downtown District" />
          </div>

          <div class="mb-3">
            <label for="description" class="form-label">Physical Description <span class="text-danger">*</span></label>
            <textarea id="description" class="form-control" rows="4" placeholder="Provide physical description including height, build, hair color, distinguishing features..." required></textarea>
        ...
        <div class="card-body">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <select id="caseId" class="form-select" required>
  ...
  <script>
    ...
    function renderCharges() {
      ...
      charges.forEach((charge, index) => {
        ...
        span.className = 'charge-badge destructive';
    ...
    form.addEventListener('submit', function(e) {
      ...
      const suspectData = {
        ...
        charges,
        suspectId: `SUS-${String(Math.floor(Math.random() * 999) + 1).padStart(3, '0')}`,
      };
      console.log('New Suspect Data:', suspectData);

      successAlert.classList.remove('d-none');

      setTimeout(() => {
        window.location.href = 'suspects.php'; // adjust URL as needed
      }, 2000);
    });
  </script>
