...
<body>
  ...
  <div class="container mb-0">
    <div class="text-left mb-4 mt-5">
      ...
      <p style="color:rgb(139, 140, 140);">
        View all police officers and detectives handling investigations.
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <div class="d-flex align-items-center mb-2">
              <div class="rounded-circle bg-primary text-white text-center fw-bold d-flex align-items-center justify-content-center me-3" style="width:44px; height:44px;">SJ</div>
              <div>
                <div class="fw-bold"> Det. Sarah Johnson</div>
                <div><small class="text-muted">Badge: DET 4521</small></div>
              </div>
            </div>
            <div class="mb-1">
              <span class="badge bg-success mb-1">Detective</span>
              <span class="badge bg-success mb-1">Active</span>
            </div>
            <div class="mb-1"><strong>Department</strong><br /><small class="text-muted">Criminal Investigations</small></div>
            ...
            <div class="mb-3"><small class="text-muted">Specialization</small><br /><span>Property Crimes</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="col officer-card">
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <div class="d-flex align-items-center mb-2">
              <div class="rounded-circle bg-primary text-white text-center fw-bold d-flex align-items-center justify-content-center me-3" style="width:44px; height:44px;">MC</div>
              <div>
                <div class="fw-bold">Michael Chen</div>
                <div><small class="text-muted">Badge: DET 4522</small></div>
              </div>
            </div>
            <div class="mb-1">
              <span class="badge bg-success mb-1">Detective</span>
            ...
            <div class="mb-3"><small class="text-muted">Specialization</small><br /><span>Organized Crime</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="col officer-card">
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <div class="d-flex align-items-center mb-2">
              <div class="rounded-circle bg-primary text-white text-center fw-bold d-flex align-items-center justify-content-center me-3" style="width:44px; height:44px;">ER</div>
              <div>
                <div class="fw-bold">Emily Rodriguez</div>
                <div><small class="text-muted">Badge: DET 4523</small></div>
              </div>
            </div>
            <div class="mb-1">
              <span class="badge bg-success mb-1">Detective</span>
            ...
            <div class="mb-1"><strong>Department</strong><br /><small class="text-muted">Cybercrime Unit</small></div>
            <div class="d-flex justify-content-between mb-1">
              <div>
                <small class="text-muted">Assigned Cases</small><br />
                <span>1</span>
            ...
            <div class="mb-3"><small class="text-muted">Specialization</small><br /><span>Cybercrime</span></div>
          </div>
        </div>
      </div>

      <!-- More officer cards below (continue the pattern as above) -->

      <div class="col officer-card">
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <div class="d-flex align-items-center mb-2">
              <div class="rounded-circle bg-primary text-white text-center fw-bold d-flex align-items-center justify-content-center me-3" style="width:44px; height:44px;">JM</div>
              <div>
                <div class="fw-bold">James Martinez</div>
                <div><small class="text-muted">Badge: DET 4524</small></div>
              </div>
            </div>
            <div class="mb-1">
              <span class="badge bg-success mb-1">Detective</span>
            ...
            <div class="mb-3"><small class="text-muted">Specialization</small><br /><span>Violent Crimes</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="col officer-card">
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <div class="d-flex align-items-center mb-2">
              <div class="rounded-circle bg-primary text-white text-center fw-bold d-flex align-items-center justify-content-center me-3" style="width:44px; height:44px;">RW</div>
              <div>
                <div class="fw-bold">Robert Williams</div>
                <div><small class="text-muted">Badge: DET 3215</small></div>
              </div>
            </div>
            <div class="mb-1">
              <span class="badge bg-primary mb-1">Senior Detective</span>
              <span class="badge bg-success mb-1">Active</span>
            </div>
            <div class="mb-1"><strong>Department</strong><br /><small class="text-muted">Narcotics Division</small></div>
            <div class="d-flex justify-content-between mb-1">
              <div>
                <small class="text-muted">Assigned Cases</small><br />
                <span>1</span>
            ...
            <div class="mb-3"><small class="text-muted">Specialization</small><br /><span>Drug Enforcement</span></div>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <div class="d-flex align-items-center mb-2">
              <div class="rounded-circle bg-primary text-white text-center fw-bold d-flex align-items-center justify-content-center me-3" style="width:44px; height:44px;">LA</div>
              <div>
                <div class="fw-bold">Lisa Anderson</div>
                <div><small class="text-muted">Badge: LT 2101</small></div>
              </div>
            </div>
            <div class="mb-1">
              <span class="badge bg-purple mb-1">Lieutenant</span>
              <span class="badge bg-success mb-1">Active</span>
            </div>
            <div class="mb-1"><strong>Department</strong><br /><small class="text-muted">Criminal Investigations</small></div>
            <div class="d-flex justify-content-between mb-1">
            ...
            <div class="mb-3"><small class="text-muted">Specialization</small><br /><span>Supervision</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card text-center shadow-sm h-100">
          <div class="card-body">
            ...
            <div class="display-5 fw-bold mb-2">6</div>
      ...
      <div class="col">
        <div class="card text-center shadow-sm h-100">
          <div class="card-body">
            ...
            <div class="display-5 fw-bold mb-2">5.5</div>
      ...
      <div class="col">
        <div class="card text-center shadow-sm h-100">
          <div class="card-body">
            ...
            <div class="display-5 fw-bold mb-2">8</div>
