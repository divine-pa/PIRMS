...
try {
  $stmt = $pdo->query("SELECT * FROM suspect ORDER BY suspect_id DESC");
            ...
            <div class="card h-100 shadow-sm">
              <div class="card-body d-flex flex-column">
                ...
                <div class="mb-3">
                  ...
                  if ($s['status'] == 'Convicted') $badgeClass = 'bg-dark';
                  ?>
                ...
                <?php if (!empty($s['charges'])): ?>
                  <div class="mt-auto pt-2 border-top">
                    ...
                    <small class="fw-bold" style="font-size:0.85rem;"><?php echo htmlspecialchars($s['charges']); ?></small>
                  </div>
                <?php endif; ?>
