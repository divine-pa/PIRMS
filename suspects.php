...
<div class="container py-4">
  ...
  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
        ...
        <div class="card-body d-flex flex-column">
          <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-3">
              ...
              <small class="text-muted">ID: SUS 001</small><br />
              <small class="text-muted">Case Linked <br /><strong>CASE-2025-081</strong></small>
            </div>
          </div>
          <div class="mb-2">
          ...
          <div class="mb-3">
            <span class="badge bg-primary">Under Investigation</span>
          </div>
    ...
    <!-- Repeat Cards for other suspects, adjust data accordingly -->
      ...
      <div class="card h-100 shadow-sm">
        <div class="card-body d-flex flex-column">
          <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-3">
              <h6 class="mb-0">Marcus Williams</h6>
              <small class="text-muted">ID: SUS 007</small><br />
              <small class="text-muted">Case Linked <br /><strong>CASE-2025-082</strong></small>
            </div>
          </div>
          <div class="mb-2">
            <small class="text-muted">Gender</small><br />
          ...
          <div class="mb-3">
            <span class="badge bg-danger">Arrested</span>
          </div>
        ...
        <div class="card-body d-flex flex-column">
          <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-3">
              ...
              <small class="text-muted">ID: SUS 003</small><br />
              <small class="text-muted">Case Linked <br /><strong>CASE-2025-083</strong></small>
            </div>
          </div>
          <div class="mb-2">
            <small class="text-muted">Gender</small><br />
      ...
      <div class="card h-100 shadow-sm">
        <div class="card-body d-flex flex-column">
          <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-3">
              <h6 class="mb-0">Julius Mattew</h6>
              <small class="text-muted">ID: SUS 004</small><br />
              <small class="text-muted">Case Linked <br /><strong>CASE-2025-084</strong></small>
            </div>
          </div>
          <div class="mb-2">
            <small class="text-muted">Gender</small><br />
      ...
      <div class="card h-100 shadow-sm">
        <div class="card-body d-flex flex-column">
          <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-3">
              <h6 class="mb-0">Mara Johnson</h6>
              <small class="text-muted">ID: SUS 005</small><br />
              <small class="text-muted">Case Linked <br /><strong>CASE-2024-185</strong></small>
            </div>
          </div>
          <div class="mb-2">
            <small class="text-muted">Gender</small><br />
        ...
        <div class="card-body d-flex flex-column">
          <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-3">
              ...
              <small class="text-muted">ID: SUS 006</small><br />
              <small class="text-muted">Case Linked <br /><strong>CASE-2025-085</strong></small>
            </div>
          </div>
          <div class="mb-2">
            <small class="text-muted">Gender</small><br />
    ...
    <!-- Add more suspect cards similarly -->
