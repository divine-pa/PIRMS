  ...
  <div class="card mx-auto" style="max-width: 410px;">
    <div class="card-body">
      ...
      <div class="mt-2 text-center small">
        ...
        <a href="#" class="text-primary text-decoration-underline fw-semibold">Request Access</a>
      </div>
    </div>
  </div>
</div>
