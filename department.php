         ...
         <div class="row g-3">
           <div class="col-md-3 department-card">
             <div class="card h-100">
               <div class="card-body">
                 <span class="badge rounded-pill bg-primary mb-2">MS</span>
                 <h6 class="card-title">Commercial Burglary </h6>
                 <p class="mb-1">Head: Det. Sarah Johnson</p>
                 <p class="mb-1">Current: 1 Active Cases</p>
               </div>
             </div>
           </div>
           <div class="col-md-3 department-card">
             <div class="card h-100">
               <div class="card-body">
                 <span class="badge rounded-pill bg-primary mb-2">MS</span>
                 <h6 class="card-title">Vehicle Theft </h6>
                 <p class="mb-1">Head: Det. Michael Chen</p>
                 <p class="mb-1">Current: 1 Active Cases</p>
               </div>
             </div>
           </div>
           <div class="col-md-3 department-card">
             <div class="card h-100">
               <div class="card-body">
                 <span class="badge rounded-pill bg-primary mb-2">MS</span>
                 <h6 class="card-title">Cybercrime Unit</h6>
                 <p class="mb-1">Head: Det. Emily Rodriguez</p>
                 <p class="mb-1">Current: 1 Active Cases</p>
               </div>
             </div>
           </div>
           <div class="col-md-3 department-card">
             <div class="card h-100">
               <div class="card-body">
                 <span class="badge rounded-pill bg-primary mb-2">MS</span>
                 <h6 class="card-title">Assault </h6>
                 <p class="mb-1">Head: Det. James Martinez</p>
                 <p class="mb-1">Current: 1 Active Cases</p>
               </div>
             </div>
           </div>
           ...
           <div class="col-md-3 department-card">
             <div class="card h-100">
               <div class="card-body">
                 <span class="badge rounded-pill bg-primary mb-2">MS</span>
                 <h6 class="card-title">Nacortics</h6>
                 <p class="mb-1">Head: Det. Robert Williams</p>
                 <p class="mb-1">Current: 1 Active Cases</p>
               </div>
             </div>
           </div>
