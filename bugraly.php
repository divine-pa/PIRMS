...
  <ul class="nav nav-pills align-items-center">
  ...
  <div class="container" style="max-width: 1024px;">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
      <div>
        <h1 class="d-inline me-2">Commercial Burglary Investigation</h1>
        <span class="badge bg-danger align-middle">High Priority</span>
        <p class="text-muted mt-2 mb-1">CASE-2025-081</p>
      </div>
    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-8">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <h6>Description</h6>
            <p class="text-muted">Investigation into a series of commercial burglaries in the downtown district. Multiple businesses affected. Evidence suggests organized crime involvement with similar modus operandi across all incidents.</p>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body d-flex gap-3 align-items-start">
            ...
            <div class="flex-grow-1">
              <h6 class="mb-1">Det. Sarah Johnson</h6>
              <div class="small text-muted">DET-4521</div>
  ...
  <div class="tab-pane fade" id="notes" role="tabpanel" aria-labelledby="notes-tab">
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-primary btn-sm" onclick="alert('Add Note')"><i class="bi bi-plus me-2"></i>Add Note</button>
      </div>
      <div class="card-body">
        <div class="bg-secondary bg-opacity-25 p-3 rounded mb-3">
          <p class="mb-2">Initial investigation reveals pattern of break-ins targeting cash registers and safes.</p>
          <div class="d-flex justify-content-between small text-muted">
            <span>Det. Johnson</span>
            <span>2025-10-15</span>
          </div>
        </div>
        <div class="bg-secondary bg-opacity-25 p-3 rounded mb-3">
          <p class="mb-2">Security footage analysis shows same suspect vehicle at multiple scenes.</p>
          <div class="d-flex justify-content-between small text-muted">
            <span>Det. Johnson</span>
        ...
        <div class="bg-secondary bg-opacity-25 p-3 rounded">
          <p class="mb-2">Forensics confirmed fingerprint match at two locations.</p>
          <div class="d-flex justify-content-between small text-muted">
            <span>Forensics Team</span>
