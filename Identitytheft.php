...
  <ul class="nav nav-pills align-items-center">
    <li class="nav-item"><a href="./index.php" class="nav-link text-white" aria-current="page">Home</a></li>
  ...
  <div class="container" style="max-width: 1024px;">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
      <div>
        <h1 class="d-inline me-2">Cybercrime Identity Theft</h1>
        <span class="badge bg-danger align-middle">High Priority</span>
        <p class="text-muted mt-2 mb-1">CASE-2025-083</p>
      </div>
    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-8">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <h6>Description</h6>
            <p class="text-muted">Cybercriminals orchestrated a massive identity theft scheme, stealing personal information to defraud vulnerable victims and extract hundreds of thousands of dollars. </p>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body d-flex gap-3 align-items-start">
            ...
            <div class="flex-grow-1">
              <h6 class="mb-1">Det. Emily Rodriguez</h6>
              <div class="small text-muted"> DET 4523</div>
              <div class="small text-muted">Cybercrime Unit</div>
            </div>
          </div>
        </div>
      </div>
