...
  <ul class="nav nav-pills align-items-center">
  ...
  <div class="container" style="max-width: 1024px;">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
      <div>
        <h1 class="d-inline me-2">Drug Trafficking</h1>
        <span class="badge bg-danger align-middle">High Priority</span>
        <p class="text-muted mt-2 mb-1">CASE-2024-185</p>
      </div>
    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-8">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <h6>Description</h6>
            <p class="text-muted">Thirty five group of men were found down town with a 30 ton of hardrugs</p>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body d-flex gap-3 align-items-start">
            ...
            <div class="flex-grow-1">
              <h6 class="mb-1">Det. Robert Williams</h6>
              <div class="small text-muted"> DET 3215</div>
              <div class="small text-muted">Narcotics Division</div>
            </div>
          </div>
        </div>
      </div>
