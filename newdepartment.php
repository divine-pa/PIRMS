...
<ul class="nav nav-pills align-items-center">
  ...
  <a href="./setting.php" class="nav-link text-white p-0" aria-label="Settings">
    ...
    <div class="mb-4">
      ...
      <p class="text-muted">
        Register a new department in the PIRMS system
      </p>
    </div>
    ...
    <div
      id="successAlert"
      class="alert alert-success d-none mb-4"
      role="alert"
    >
      Department added successfully! Redirecting to departments list...
    </div>
        ...
        <div class="card-header d-flex align-items-center gap-3">
          ...
          <div>
            ...
            <small class="text-muted"
              >Enter details about the new department</small
            >
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="mb-3">
            <label for="deptHead" class="form-label"
              >Department Head <span class="text-danger">*</span></label
            >
            <input
              type="text"
              id="deptHead"
 ...
 <!--enf of footer section -->
  ...
  <script>
    ...
    form.addEventListener('submit', (e) => {
      ...
      const requiredFields = ['deptName', 'deptHead'];
      ...
      const departmentData = {
        ...
        head: form.deptHead.value.trim(),
        location: form.location.value.trim(),
        phone: form.phone.value.trim(),
        email: form.email.value.trim(),
        status: form.status.value,
        departmentId: `DEP-${String(Math.floor(Math.random() * 999) + 1).padStart(3, '0')}`,
      ...
      setTimeout(() => {
        window.location.href = 'departments.php'; // Adjust URL accordingly
      }, 2000);
    });
  </script>
