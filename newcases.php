      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" placeholder="e.g., Commercial Burglary Investigation" required>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="description" rows="4" placeholder="Provide detailed description of the case..." required></textarea>
            <div class="invalid-feedback">Case Description is required.</div>
          </div>

          <div class="mb-3">
            <label for="dateStarted" class="form-label">Date Started</label>
            <input type="date" class="form-control" id="dateStarted" value="" required>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <select class="form-select" id="officerSelect" required>
                ...
                <option>Det. Emily Rodriguez</option>
                <option>Det. James Martinez</option>
                <option>Det. Robert Williams</option>
                <option>Det. Amanda Foster</option>
                <option>Det. David Park</option>
                <option>Det. Lisa Thompson</option>
              </select>
   ...
   <script>
    ...
    form.addEventListener('submit', (e) => {
      ...
      const caseData = {
        ...
        officer: form.officerSelect.value,
      ...
      setTimeout(() => {
        window.location.href = 'cases.php'; // Adjust link as needed
      }, 2000);
    });
  </script>
